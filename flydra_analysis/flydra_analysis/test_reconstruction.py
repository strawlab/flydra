...
def test_retracking_without_data_association():
    ...
    orig_fname = pkg_resources.resource_filename('flydra_analysis.a2','sample_datafile-v0.4.28.h5')
...
def check_offline_reconstruction(with_water=False,
    ...
    try:
        flydra_analysis.offline_data_save.save_data( fname=data2d_fname,
                                            data2d=D['data2d'],
                                            fps=fps,
        ...
        d2 = flydra_core.reconstruct.Reconstructor(data2d_fname).get_intrinsic_nonlinear('cam03')
...
def check_online_reconstruction(with_water=False,
    ...
    model = flydra_core.kalman.dynamic_models.get_kalman_model(name=D['dynamic_model_name'],dt=(1.0/fps))
