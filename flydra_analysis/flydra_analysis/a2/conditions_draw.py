...
##             print l
    ...
    def get_lines_broken(self):
        if 1:
            mark_downwind = (-0.34217471182253395, -0.049713741423482401, -0.19355194735726916)
            mark_upwind = (1.2876590202076592, 0.010489177564320891, 0.12787225786089762)
            clean_downwind = (-0.056335257988488305, 0.29128361824544396, -0.04660008661573465)
            clean_upwind = (1.6976573714828826, 0.29557154652605472, -0.097584020093109847)


            topmark_downwind = (0.53170860804444731, -0.16409787403831047, -0.28615024916121734)#(1.3096717388755901, 0.091305659429098823, 0.732811634933068)
            topmark_upwind = (0.9631957795119126, -0.0033269269379037625, 0.35236001377287235)
            topclean_downwind = (0.45463209212301769, 0.29075143705630435, 0.3224900075984799)
            topclean_upwind = (1.0078270653666062, 0.29186733966356126, 0.3199189595274578)

        else:
            mark_downwind = (-0.33526447401078729, -0.048931719337347232, -0.189574764923057)
            mark_upwind = (1.3328671859305408, 0.0064117386996079481, 0.10473711070863806)
            clean_downwind = (0.1647028850715552, 0.27253360129016713, 0.072188689328985672)
            clean_upwind = (1.9200691965703456, 0.31092100990246491, -0.2212166344677361)


        verts = [mark_downwind, #0
                 mark_upwind,#1
                 clean_upwind,#2
                 clean_downwind,#3
                 topmark_downwind,#4
        ...
        if 0:
            ...
            lines = [ [0,1], [1,2], [2,3], [3,0], #floor
                      [1,5], [5,4], [4,0], #mark wall
                      [3,6], [6,7], [7,2], # clean wall
                      ]
