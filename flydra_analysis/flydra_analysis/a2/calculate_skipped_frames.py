...
def calculate_skipped_frames(h5_filename=None,
...
def main():
    ...
    parser.add_argument('kalman_file', type=str,
                        help="file with 3D data")
    parser.add_argument("--output-h5", type=str,
                        help="filename for output .h5 pandas datastore")
    args = parser.parse_args()

    if args.output_h5 is None:
        args.output_h5 = args.kalman_file + '.skipped_info.h5'

    calculate_skipped_frames(kalman_filename=args.kalman_file,
