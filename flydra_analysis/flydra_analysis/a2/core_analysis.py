...
def _get_initial_file_info(kresults):
    ...
    if hasattr(kresults.root,'textlog'):
        try:
            time_model = (
                flydra_analysis.analysis.result_utils.get_time_model_from_data(
                kresults))
...
class FileContextManager:
    ...
    def get_fps(self):
        return flydra_analysis.analysis.result_utils.get_fps(self._2d_file,
                                                    fail_on_error=True)
    ...
    def read_textlog_header(self):
        return flydra_analysis.analysis.result_utils.read_textlog_header(self._data_file)
