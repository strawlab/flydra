...
##             print
    ...
    if intrinsics_reconstructor and os.path.exists(intrinsics_reconstructor):
        ...
        reconstructor = flydra_core.reconstruct.Reconstructor(cal_source=intrinsics_reconstructor)
    ...
    if row_keys is not None:
        ...
        flydra_core.reconstruct.save_ascii_matrix(row_keys,os.path.join(calib_dir,'obj_ids_zero_indexed.dat'),isint=True)
...
"""
    ...
    parser.add_option("--undistort-intrinsics-yaml",
