...
ext_modules.append(Extension(name='flydra_analysis.a2.fastfinder_help',
                             sources=['flydra_analysis/a2/fastfinder_help.pyx'],
                             include_dirs=[np.get_include()],
                             ))

setup(name='flydra_analysis',
      version=version,
      author='Andrew Straw',
...
# testing
    ...
    'flydra_analysis.kdviewer.plugins':['default = flydra_analysis.a2.conditions_draw:default',
      ...
      package_data={
                    'flydra_analysis.a2':['kdmovie_saver_default_path.kmp',
                                 'sample_*.h5',
                                 'sample_*.mat',
