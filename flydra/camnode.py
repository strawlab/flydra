...
pt_fmt = '<dddddddddBBddBddddddBB' # keep in sync with MainBrain.py
...
class ProcessCamClass(object):
    ...
    def _convert_to_old_format(self, xpoints ):
        points = []
        for xpt in xpoints:
            (x0_abs, y0_abs, area, slope, eccentricity, max_abs_diff, max_std_diff) = xpt
