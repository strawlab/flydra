...
def kalman_smooth(orig_rows,
    ...
    x = numpy.zeros( frames.shape, dtype=numpy.float )
    y = numpy.zeros( frames.shape, dtype=numpy.float )
    z = numpy.zeros( frames.shape, dtype=numpy.float )
    R = numpy.zeros( (frames.shape[0],3,3), dtype=numpy.float )
