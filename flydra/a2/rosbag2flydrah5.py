...
def convert_to_flydrah5(bag_file, topic_name='pointcloud', out_h5=None, reconstructor=None):
    ...
    kalman_saver_info_instance = flydra_kalman_utils.KalmanSaveInfo(name='mamarama, units: mm')
    KalmanEstimatesDescription = kalman_saver_info_instance.get_description()
    h5data3d_kalman_estimates = ct(root, 'kalman_estimates', KalmanEstimatesDescription,
                                   "3d data")
...
def main():
    ...
    convert_to_flydrah5(args.bag_file, topic_name=args.topic, out_h5=args.out_h5, reconstructor=args.reconstructor)
