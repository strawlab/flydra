...
//!
//! @version $Revision: 1.6 $ $Name: at90usb128-demo-hidgen-last $ $Id: usb_drv.c,v 1.6 2006/01/17 15:26:57 rletendu Exp $
//!
//! @todo
//! @bug
...
//!
//! EXAMPLE:
//! usb_configure_pipe(EP_CONTROL,TYPE_CONTROL, DIRECTION_OUT, SIZE_64, ONE_BANK, NYET_DISABLED);
//!
//! NOTE:
//! The endpoint 0 shall always be configured in CONTROL type.
//!
