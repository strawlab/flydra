...
##            small_datafile_filename = small_filename + '.smd'
    ...
    def OnManualTriggerDevice1(self,event):
        ...
        sender.sendto('1',(Mainbrain.g_hostname,28994))#common_variables.trigger_network_socket_port))

    def OnManualTriggerDevice2(self,event):
        sender = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        sender.sendto('2',(Mainbrain.g_hostname,28994))#common_variables.trigger_network_socket_port))

    def OnManualTriggerDevice3(self,event):
        sender = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        sender.sendto('3',(Mainbrain.g_hostname,28994))#common_variables.trigger_network_socket_port))
