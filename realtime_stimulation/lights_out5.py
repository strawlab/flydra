...
if 1:
    LIGHTS_ON = '1'
    LIGHTS_OFF = '0'
    LIGHTS_DARKFLASH_100MSEC = 'S1'
    LIGHTS_DARKFLASH_200MSEC = 'SS1'
    LIGHTS_DARKFLASH_500MSEC = 'SSS1'

condition_list = [LIGHTS_OFF,
                  LIGHTS_ON,
                  LIGHTS_DARKFLASH_100MSEC,
                  LIGHTS_DARKFLASH_200MSEC,
...
log_file = open(time.strftime( 'lights_out5_%Y%m%d_%H%M%S.log' ), mode='wb')
#log_file = sys.stdout
