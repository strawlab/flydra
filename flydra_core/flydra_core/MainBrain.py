...
#        clear_background=(std_srvs.srv.Empty),
    ...
    def do_synchronization(self,new_fps=None):
        ...
        self.trigger_device.synchronize(flydra_core.common_variables.sync_duration+1.0)
        if new_fps is not None:
    ...
    def set_new_tracker(self, kalman_model_name, new_fps=None):
        ...
        dynamic_model = flydra_core.kalman.dynamic_models.get_kalman_model(name=kalman_model_name,dt=dt)
