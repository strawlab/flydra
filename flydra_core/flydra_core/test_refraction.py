...
def test_roots():
    poly = [-0.77628891, 0.23754440646, -0.181206489286, 0.0499191270735, -0.00381881322112]
    actual = _Roots3And4.py_real_nonnegative_root_less_than(poly[0], poly[1], poly[2], poly[3], poly[4],
                                                           0.153, 1e-7)
